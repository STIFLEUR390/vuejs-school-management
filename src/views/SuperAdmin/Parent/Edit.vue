    ...
    <div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ $t('update_parent') }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $t('update_parent') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
<!--                                <h3 class="card-title">Quick Example</h3>-->
                            ...
                            <form @submit.prevent="updatedParent">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary">{{ $t('update_parent') }}</button>
                                </div>
                            </form>
                    </div>
                </div>
