                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $t('parents') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ $t('parents') }}</h3>
                                <router-link :to="{name: 'SuperAdminParentCreate'}" style="float: right;" class="btn btn-primary">{{ $t('create_parent') }}</router-link>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        <tr v-for="(user, id) in parents" :key="id">
                                            ...
                                            <td>
                                                ...
                                                <router-link v-if="!user.deleted_at" :to="{name: 'SuperAdminParentEdit', params: { id: user.id }}" class="btn btn-outline-primary mr-1">
...
<script>
    ...
    export default {
        name: "Parent",
        mounted() {
            this.axios.get("/superadmin/user?role=parent")
                .then((response) => {
