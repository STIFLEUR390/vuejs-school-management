                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $t('admin') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ $t('all_admins') }}</h3>
                                <router-link :to="{name: 'SuperAdminAdminCreate'}" style="float: right;" class="btn btn-primary">{{ $t('create_admin') }}</router-link>
                            </div>
                            <div class="card-body">
                                <table id="datatable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="(user, id) in admins" :key="id">
                                            <td>{{ id + 1 }}</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <router-link v-if="!user.deleted_at" :to="{name: 'SuperAdminAdminEdit', params: { id: user.id }}" class="btn btn-outline-primary mr-1">
...
<script>
    ...
    export default {
        name: "Admin",
        mounted() {
            this.axios.get("/superadmin/user?role=admin")
                .then((response) => {
