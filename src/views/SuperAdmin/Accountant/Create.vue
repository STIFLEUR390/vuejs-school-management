    ...
    <div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ $t('create_accountant') }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $t('create_accountant') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
<!--                                <h3 class="card-title">Quick Example</h3>-->
                            ...
                            <form @submit.prevent="createAccountant">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">{{ $t('provide_address') }}</small>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary">{{ $t('create_accountant') }}</button>
                                </div>
                            </form>
                    </div>
                </div>
