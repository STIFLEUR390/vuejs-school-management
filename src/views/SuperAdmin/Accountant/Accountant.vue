                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $t('accountants') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ $t('accountants') }}</h3>
                                <router-link :to="{name: 'SuperAdminAccountantCreate'}" style="float: right;" class="btn btn-primary">{{ $t('create_accountant') }}</router-link>
                            </div>
                            <div class="card-body">
                                <table id="datatable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="(user, id) in accountants" :key="id">
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <router-link v-if="!user.deleted_at" :to="{name: 'SuperAdminAccountantEdit', params: { id: user.id }}" class="btn btn-outline-primary mr-1">
...
<script>
    ...
    export default {
        name: "Accountant",
        mounted() {
            this.axios.get("/superadmin/user?role=accountant")
                .then((response) => {
