    ...
    <div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ $t('update_accountant') }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $t('update_accountant') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
<!--                                <h3 class="card-title">Quick Example</h3>-->
                                <router-link :to="{name: 'SuperAdminAccountantReport'}" class="btn btn-primary">
                            ...
                            <form @submit.prevent="updatedAccountant">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">{{ $t('provide_email') }}</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="phone">{{ $t('phone_number') }}</label>
                                        <input type="text" class="form-control" id="phone" name="phone" v-model="form.phone">
                                        <small class="form-text text-muted">{{ $t('provide_phone_number') }}</small>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">{{ $t('provide_gender') }}</small>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small id="" class="form-text text-muted">{{ $t('provide_address') }}</small>
                                    </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary">{{ $t('update_accountant') }}</button>
                                </div>
                            </form>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            async updatedAccountant(){
                ...
                formData.append('role', 'accountant')
